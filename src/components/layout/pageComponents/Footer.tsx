...
const Footer = () => {
  return (
    <footer className="bg-[#2C332D] px-2 py-4 text-[#A8B0A9] xl:px-5">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 my-5">
          <div className="max-w-md">
            ...
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="flex items-center justify-center rounded-full border border-white/10 bg-white/5 transition-all duration-200 hover:border-accent hover:bg-accent hover:text-white p-2"
              >
                <SocialMedia2 />
              </a>
              <a
